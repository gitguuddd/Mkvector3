...
extern void split(char pchoice, char strat, Vector<stud>::iterator &up);
extern void splitd(char pchoice, char strat, deque<stud>::iterator &upd);
extern void splitl(char pchoice, char strat, list<stud>::iterator &upl);
