...
## Programa pritaikyta mano paties kurtam vektoriui, dėl nesuderinamumo padaryti šie pakeitimai (naudojama 1.5 programos versija):
- Užkomentuotas Studentų sąrašo atspausdinimas konsolėje
- Užkomentuota papildomos užduoties dalijimo strategija naudojant vektorių
- Sudubliuotos template'inės funkcijos
